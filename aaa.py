...
app = Application(backend='uia').start("C:\Program Files (x86)\Elcomsoft Password Recovery\Advanced Archive Password Recovery\ARCHPR.exe /dontstart G:\JGB\山东\山东_SCJ_2022_02月 - 副本.zip")
# 描述Notepad.exe进程内的窗口
